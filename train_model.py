...
def main():
    ...
    gen = generator.GEN()
    serializers.load_npz("result_u/gen_iter_3000", gen)
    print('generator loaded')

    dis = discriminator.DIS()
    serializers.load_npz("result_u/gen_dis_iter_3000", dis)
    print('discriminator loaded')

    # paired dataset
    paired_dataset = Rough2LineDataset(
        "dat/paired_dataset.dat", root + "rough/", root + "line/",
        train=True, size = 256)
